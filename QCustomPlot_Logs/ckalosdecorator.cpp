...
#define ARRAY_DIM 200000 /// max number of lines to auto-stop proessing
    ...
    QVector<double> qvMinData; // data array
    QVector<double> qvMaxData; // data array
    ...
    dMinXAxis = *std::min_element(qvMinData.constBegin(), qvMinData.constEnd());
    dMaxXAxis = *std::max_element(qvMaxData.constBegin(), qvMaxData.constEnd());
